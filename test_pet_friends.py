...
def test_get_api_key_for_invalid_key(email=valid_email, password='igorCh.78.'):
    """Проверяем что запрос API ключа для неправильного пароля не возвращает статус 200"""
...
def test_get_api_key_for_invalid_user(email='igor_chunaev@gmail.com', password=valid_password):
